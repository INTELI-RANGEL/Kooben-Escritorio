object FrmRecetario: TFrmRecetario
  Left = 0
  Top = 0
  Caption = 'Receta'
  ClientHeight = 501
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object pnlModoPreparacion: TPanel
    Left = 0
    Top = 320
    Width = 1062
    Height = 181
    Align = alClient
    Caption = 'pnlModoPreparacion'
    TabOrder = 0
    object jvlbl2: TJvLabel
      ...
      Height = 19
      Align = alTop
      Caption = 'Modo de preparaci'#243'n:'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -16
      Font.Name = 'Calibri'
    ...
    object PreparacionReceta: TcxDBMemo
      AlignWithMargins = True
      Left = 4
      Top = 29
      Align = alClient
      DataBinding.DataField = 'PreparacionReceta'
  ...
  object GroupBox1: TGroupBox
    ...
    object Panel2: TPanel
      ...
      object cxGrid1: TcxGrid
        ...
        object tvPartidas: TcxGridDBTableView
          ...
          OnCellDblClick = tvPartidasCellDblClick
    ...
    object Imagen: TcxDBImage
      ...
      DataBinding.DataSource = dsImagen
      PopupMenu = dxPopupIMG
  ...
  object pnlRelativo: TPanel
    ...
    Padding.Bottom = 1
    TabOrder = 8
    object Leyenda_Relativo: TDBMemo
      Left = 2
      Top = 2
      Width = 297
      Height = 29
      ...
      ParentFont = False
      TabOrder = 0
      OnEnter = Leyenda_RelativoEnter
      OnExit = Leyenda_RelativoExit
    end
  end
  ...
  object repReceta: TfrxReport
    ...
    ReportOptions.LastChange = 42257.487602361100000000
  ...
  object dsRecetaImagen: TDataSource
    DataSet = cdRecetaImagen
    Left = 224
    Top = 304
  end
  ...
  object dxPopupIMG: TdxRibbonPopupMenu
    BarManager = DxManager1
    ItemLinks = <
      item
        Visible = True
        ItemName = 'DxBtnLoadImg'
      end
      item
        Visible = True
        ItemName = 'dxBtnCopyImg'
      end>
    UseOwnFont = False
    Left = 280
    Top = 168
