...
uses
  ...
  JvLabel, pngimage, ExtCtrls, Buttons, PngSpeedButton, UTFrmDatosCatalogo,
  UTFrmDatosCiudad, frxClass, frxDBSet, NxColumns, NxDBColumns,UinteliDialog,
  ...
  cxFilter, cxData, cxDataStorage, cxNavigator, cxDBData, dxRibbon, ImgList,
  dxSkinsForm, cxGridLevel, cxGridCustomView, cxGridCustomTableView,
...
type
  TFrmCiudad = class(TFrmCatalogo)
    ...
    cxCodigoCiudad: TcxGridDBColumn;
    cxTituloCiudad: TcxGridDBColumn;
    cxDescripcion: TcxGridDBColumn;
    cxTituloEstado: TcxGridDBColumn;
    cxTituloPais: TcxGridDBColumn;
