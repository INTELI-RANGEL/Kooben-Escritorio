...
uses
  ...
  cxGridDBTableView, dxRibbon, ImgList, dxSkinsForm, cxGridLevel,
...
type
  TFrmPais = class(TFrmCatalogo)
    ...
    cxCodigoPais: TcxGridDBColumn;
    cxTituoPais: TcxGridDBColumn;
    cxNacionalidad: TcxGridDBColumn;
    cxComentarios: TcxGridDBColumn;
