inherited FrmTiposImpuesto: TFrmTiposImpuesto
  ...
  inherited PanelFiltro: TcxGroupBox
    inherited GroupBoxFiltro: TcxGroupBox
      ...
      object FCodigoTipoImpuesto: TEdit
        Left = 16
        Top = 184
        Width = 121
        Height = 21
        TabOrder = 1
        OnKeyPress = FCodigoTipoImpuestoKeyPress
      end
    end
  end
  inherited PanelPrincipal: TPanel
    inherited CxGridDatos: TcxGrid
      inherited CxDbGridDatos: TcxGridDBTableView
        object ColCodigoTipoImpuesto: TcxGridDBColumn
          Caption = 'C'#243'digo'
          DataBinding.FieldName = 'CodigoTipoImpuesto'
        end
        object ColTituloTipoImpuesto: TcxGridDBColumn
          Caption = 'T'#237'tulo'
          DataBinding.FieldName = 'TituloTipoImpuesto'
        end
      end
    end
  end
  ...
  object frxTiposImpuesto: TfrxDBDataset
  ...
  object frxReporteTiposImpuesto: TfrxReport
    Version = '4.10.3'
