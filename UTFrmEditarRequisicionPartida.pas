unit UTFrmEditarRequisicionPartida;

interface

uses
  Windows, Messages, SysUtils, Variants, Classes, Graphics, Controls, Forms,
  Dialogs, StdCtrls, DBCtrls, DB, DBClient, ClientModuleUnit1, UInteliDialog,
  AdvGlowButton, ExtCtrls, Mask, RxToolEdit, RxCurrEdit, RXDBCtrl, JvExControls,
  JvLabel;

type
  TFrmEditarRequisicionPartida = class(TForm)
    CodigoInsumo: TEdit;
    ...
    dsVerificaRequisicion: TDataSource;
...
var
  FrmEditarRequisicionPartida: TFrmEditarRequisicionPartida;
...
procedure TFrmEditarRequisicionPartida.CodigoInsumoEnter(Sender: TObject);
begin
  CodigoInsumo.Text := TextoOriginal;
end;

procedure TFrmEditarRequisicionPartida.CodigoInsumoExit(Sender: TObject);
begin
...
procedure TFrmEditarRequisicionPartida.CodigoInsumoKeyPress(Sender: TObject;
  var Key: Char);
var
  Valor: String;
...
procedure TFrmEditarRequisicionPartida.FormShow(Sender: TObject);
var
  LocCursor: TCursor;
begin
  try
