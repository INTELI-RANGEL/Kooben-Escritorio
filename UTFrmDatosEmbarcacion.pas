...
uses
  ...
  JvExControls, JvLabel, Mask, DBCtrls;

type
  TFrmDatosEmbarcacion = class(TFrmDatosCatalogo)
    DBEdit1: TDBEdit;
    DBEdit2: TDBEdit;
    JvLabel1: TJvLabel;
    JvLabel2: TJvLabel;
...
var
  FrmDatosEmbarcacion: TFrmDatosEmbarcacion;

implementation

{$R *.dfm}

procedure TFrmDatosEmbarcacion.FormShow(Sender: TObject);
begin
  inherited;
