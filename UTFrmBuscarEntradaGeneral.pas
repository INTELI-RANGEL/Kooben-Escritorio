  ...
  try
    ...
    try
      ...
      if cdAnios.RecordCount = 0 then
        raise InteligentException.CreateByCode(22, ['Entradas Almacén General']);
...
begin
  ...
  try
    if Anio.ItemIndex = -1 then
      raise InteligentException.CreateByCode(24, ['Debe seleccionar un año para proceder a realizar la busqueda de Entradas']);
