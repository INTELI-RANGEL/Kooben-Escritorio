...
uses
  ...
  dxSkinOffice2013LightGray, AdvGlowButton;
...
begin
  try
    ...
    begin
      ...
      EditTituloEstado.Text := registro.Valor['TituloEstado'] + ', ' + registro.Valor['TituloPais'];
...
begin
  ...
  begin
    ...
    editTituloEstado.Text := cdEstado.FieldByName('TituloEstado').AsString + ', ' + cdEstado.FieldByName('TituloPais').AsString;
  end;
end;
