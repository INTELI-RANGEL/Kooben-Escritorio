...
uses
  ...
  ClientModuleUnit1, UInteliDialog, Spin;
  ...
  Begin
    ...
    Begin
      ...
      Begin
        ...
        Try
          CadenaValor := DateToStr(Excel.ActiveSheet.Range[ColumnaNombre(Col + 1) + Trim(IntToStr(Ren)), ColumnaNombre(Col + 1) + Trim(IntToStr(Ren))].Value2);
        Except
          CadenaValor := Excel.ActiveSheet.Range[ColumnaNombre(Col + 1) + Trim(IntToStr(Ren)), ColumnaNombre(Col + 1) + Trim(IntToStr(Ren))].Value2;
        End;
      End
      Else
        CadenaValor := Excel.ActiveSheet.Range[ColumnaNombre(Col + 1) + Trim(IntToStr(Ren)), ColumnaNombre(Col + 1) + Trim(IntToStr(Ren))].Value;

      StringGrid1.Cells[Col + 1, Ren] := CadenaValor;
    End;

    AltoRenglon := Excel.Rows[Ren].RowHeight;
    StringGrid1.RowHeights[1] := AltoRenglon;
    Inc(Ren);
  End;
