...
uses
  Uregistro, UTFrmArbolAccesos, UTFrmMuestraAccesos, ClientModuleUnit1,
...
begin
  ...
  Try
    ...
    CrearConjunto(cdFiltrado, 'nuc_organizacion_seleccion', ccSelect);
    cdFiltrado.Open;
  ...
  try
    Try
      ...
      begin
        ...
        Try
          if ClientModule1.cdOrganizacion.ProviderName = '' then
          ...
          if ClientModule1.CdEstructuraOrganizacion.ProviderName = '' then
