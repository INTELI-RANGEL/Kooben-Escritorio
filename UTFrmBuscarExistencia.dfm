object FrmBuscarExistencia: TFrmBuscarExistencia
  Left = 0
  Top = 0
  Caption = 'Abrir Registro de Existencias (Inventario)'
  ClientHeight = 470
  ClientWidth = 917
  Color = clBtnFace
    ...
    object TsRecientes: TcxTabSheet
      ...
      object lvRecientes: TListView
        ...
        Columns = <
          ...
          item
            Caption = 'Nombre Elabor'#243
          end
          item
            Caption = 'Nombre Autoriz'#243
          end
          item
            Caption = 'Estado'
          end
